...
namespace DataBagDll
{
    ...
    public sealed class DataBag
    {
        ...
        public static string Empty { get; } = SerializeWithName("Empty");
        public static string Message(string message) => SerializeWithName("Message", message);
        ...
        public override string ToString() => $"{DataName}: {string.Join(',', Data.Select((d, i) => $"[{i}]{d}"))}";
    }
}
